...
namespace H2O_odf
{
    ...
    { 
        public void makeOdf()
        {
            ...
            string filepath = @"C:\Users\park\source\repos\H2O_odf\H2O_odf\";
            ...
            {
                i++;
                activeDir = new DirectoryInfo(startpath + "(" + i.ToString() + ")");
            }
            activeDir.Create();
            startpath = activeDir.ToString();
            ...
            while (File.Exists(filepath+ refilename + @".odt"))
            {
                i++;
                refilename = filename + "(" + i.ToString() + ")";
            }
            filename = refilename;

            try
            {
                ZipFile.CreateFromDirectory(startpath, filepath + filename + @".odt");
            }
            catch (IOException)
            {
    ...
    {
        private string file;
        private StyleDetail detail = new StyleDetail();
