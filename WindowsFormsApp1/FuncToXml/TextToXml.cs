                    ...
                    for (int controlList = 0; controlList < controlListCount; controlList++)
                    {
                        ...
                        if (hasTable)
                        {
                            ...
                            for (int rowIndex = 0; rowIndex < json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"].Count(); rowIndex++)
                            {
                                ...
                                {
                                    //text
                                    for (int k = 0; k < json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"].Count(); k++)
                                    {
                                        //전체 텍스트 가져오기
                                        pcontent = null; // p text
                                        try
                                        {
                                            object obj = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["text"].Value<object>();

                                            if (obj != null)
                                                pcontent = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["text"].Value<string>();
                                        }
                                        /////////////////////////////////////////////////////////////글자가 없을 때
                                        catch (Exception e)
                                        {
                                            int nullPStyle = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"][0]["shapeId"].Value<int>();
                                            float nullPFontSize = json["docInfo"]["charShapeList"][nullPStyle]["baseSize"].Value<float>() / 100;
                                        ...
                                        // 스타일별 텍스트 개수
                                        spancount = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"].Count(); // p 안 text style count
                                                                                                                                                                                                                                                                        // 스타일별 텍스트 아이디
                                        pstyle = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"][0]["shapeId"].Value<int>();
                                        ...
                                        {
                                            //스타일이 시작되는 위치
                                            current_position = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"][j]["position"].Value<int>();

                                            string subcontent;
                                            if (j < spancount - 1)
                                            {
                                                next_position = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"][j + 1]["position"].Value<int>();
                                                if (i == 0)
                                                {
                                                    //current_position = current_position - 16 < 0 ? 0 : current_position - 16;
                                                    //next_position -= 16;
                                            ...
                                            //스타일 추가 및 내용 추가
                                            //스타일의 아이디
                                            int currentstyle = json["bodyText"]["sectionList"][s]["paragraphList"][i]["controlList"][controlList]["rowList"][rowIndex]["cellList"][colIndex]["paragraphList"]["paragraphList"][k]["charShape"]["positionShapeIdPairList"][j]["shapeId"].Value<int>();
